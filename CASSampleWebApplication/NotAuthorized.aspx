...
<head>
    ...
    <title>CAS .NET Example Web Application</title>
...
<form id="form1" runat="server">
    ...
    <h1 class="main_title">
        <a href="#">CAS .NET Web Application </a>
    </h1>
    ...
    <div id="container">
        <div id="inner_container">
            <div id="content">
                ...
                <h2>
                    You [<%= User.Identity.Name %>] are
                    <u>
                        <i>not authorized</i>
                    </u> to access the requested resource.
                </h2>
                ...
                <% }
                   ...
                   { %>
                    <p>
                        The following permissions are available and have been assigned to you:<br/>
